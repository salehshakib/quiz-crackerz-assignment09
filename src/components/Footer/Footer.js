...
const Footer = () => {
    return (
        <div className='bg-neutral'><footer className="footer items-center p-4 bg-neutral text-neutral-content w-5/6 mx-auto">
            <div className="items-center grid-flow-col ">
                ...
                <p>Copyright © Saleh Shakib, 2022 - All right reserved</p>
            </div>
