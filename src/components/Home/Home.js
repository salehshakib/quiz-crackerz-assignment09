  ...
  return (
    ...
    <div className="bg-white">
        ...
        <div className="md:w-1/2 w-full flex justify-center items-center mx-auto">
          <div className="p-10">
            <h1 className="md:text-5xl text-3xl">
              Keep Learning in the{" "}
              <span className="text-primary font-bold">
                moments that matter
              </span>
            </h1>
            <h1 className="my-5 md:text-lg text-base">
              Quiz Whiz is one of the most popular online course marketplaces on
              the web. This educational platform has over{" "}
              <span className="text-primary font-bold">40 million</span>{" "}
              students and{" "}
              <span className="text-primary font-bold">50 thousand</span>{" "}
              instructors and subject matter experts creating online courses.
            </h1>
      ...
      <div className="bg-gray-200">
        <div className="md:text-5xl text-2xl font-bold text-center w-full md:w-5/6 mx-auto md:mb-16 pt-8 border-4">
          Our Courses
        </div>
